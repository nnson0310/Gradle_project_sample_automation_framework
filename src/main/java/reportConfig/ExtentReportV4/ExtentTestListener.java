package reportConfig.ExtentReportV4;//package reportConfig.ExtentReportV4;
//
...
//        htmlReport.config().setDocumentTitle("Facebook Testcase");
//        htmlReport.config().setReportName("Facebook Testcase");
